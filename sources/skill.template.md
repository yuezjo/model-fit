...
{{CARD_RULES}} Treat this latest card, its referenced requirements, and stop conditions as the pending agreement; no task-state file. Always stop here, including when keeping the current setting.
