---
name: "model-fit-cheapskate-staged"
description: "Explicit model-selection preflight only. Budget-minded advice for the current stage of a justified staged workflow; recommend available model/effort choices, then pause for confirmation."
---
