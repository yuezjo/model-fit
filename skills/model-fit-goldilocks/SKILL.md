---
name: "model-fit-goldilocks"
description: "Explicit model-selection preflight only. Conservative advice for the whole submitted task; recommend available model/effort choices, then pause for confirmation."
---
